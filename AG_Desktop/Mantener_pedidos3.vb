...
Public Class Mantener_pedidos3

    Private Sub Mantener_pedidos3_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        If ComboBox1.Text = "" Then
            MsgBox("Seleccione un diseño para agregar")
        Else
            Dim diseno As String = ComboBox1.Text
            If TextBox1.Text = "" Then
                MsgBox("Ingrese una cantidad de diseños")
            Else
                If IsNumeric(TextBox1.Text) Then

                    If TextBox12.Text = "" Then
                        MsgBox("Debe ingresar un color")
                    Else
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        If TextBox2.Text = "" Or ComboBox2.Text = "" Or ComboBox3.Text = "" Or TextBox5.Text = "" Or TextBox5.Text = "" Or TextBox14.Text = "" Or TextBox15.Text = "" Or TextBox16.Text = "" Then
            MsgBox("Debe llenar todos los campos del nuevo diseño")
        ElseIf IsNumeric(TextBox16.Text) = False Then
            MsgBox("El campo de cantidad debe ser numérico")
        Else
            ...
            Try
                cmd.ExecuteNonQuery()
                MsgBox("Diseño creado exitosamente.")
            ...
            Catch ex As Exception
                MsgBox("Error en el ingreso de los datos de diseño")
    ...
    Private Sub Button3_Click(sender As System.Object, e As System.EventArgs) Handles Button3.Click
        ...
        For i = 0 To ListView1.Items.Count - 1
            ...
            Mantener_Pedidos2.ListView1.Items.Add(item)

        Next
        Me.Hide()
        Mantener_Pedidos2.Show()
        Mantener_Pedidos2.BringToFront()
    End Sub
